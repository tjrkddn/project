...
void save_data(int stock[], int sales[], int inventory[], char product_names[][50]) {
...
void load_data(int stock[], int sales[], int inventory[], char product_names[][50]) {
...
int main() {
	...
	while (1) {
		...
		case 4:
			...
			break;
		case 5:
			save_data(stock, sales, inventory, product_names);
			break;
		case 6:
			load_data(stock, sales, inventory, product_names);
			break;
		case 7:
			printf("프로그램을 종료합니다.\n");
